"""
Alert Aid - Vercel Serverless Backend
FastAPI application running as a serverless function on Vercel
"""
...
# Simple rule-based risk calculation (no ML dependencies)
